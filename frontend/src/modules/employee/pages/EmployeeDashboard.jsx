...
const EmployeeDashboard = () => {
  ...
  const handleApplyLeave = () => {
    alert("Navigating to My Leave requests desk... Directing application forms.");
  };

  const handleDownloadPayslip = () => {
    alert("Compiling payslip invoice... File Jane_Doe_June_2026.pdf has been downloaded.");
  };

  const handleViewAttendance = () => {
    alert("Navigating to My Attendance calendars...");
  };

  const handleEditProfile = () => {
    alert("Navigating to Profile Settings panel...");
  };
    ...
    <div className="space-y-6 pb-12 font-sans">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <PayrollWidget payroll={mockEmployee.payroll} />
            <CalendarWidget />
          </div>
        </div>
